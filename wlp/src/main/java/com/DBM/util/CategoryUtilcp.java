...
import com.DBM.domain.WF_B_classifycategory;
 ...
 *
 */
public class CategoryUtilcp {

	private  List<WF_B_classifycategory> twoCateList = null;
	
	private  List<WF_B_classifycategory> threeCateList = null;
	...
	public List<WF_B_classifycategory> getTwoCateList() {
		return twoCateList;
	}

	public void setTwoCateList(List<WF_B_classifycategory> twoCateList) {
		this.twoCateList = twoCateList;
	}

	public List<WF_B_classifycategory> getThreeCateList() {
		return threeCateList;
	}

	public void setThreeCateList(List<WF_B_classifycategory> threeCateList2) {
		this.threeCateList = threeCateList2;
	}
