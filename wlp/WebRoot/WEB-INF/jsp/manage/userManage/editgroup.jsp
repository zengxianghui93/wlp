...
<body>
   ...
   <!--  <div class="YJ2016_HTRote">
    ...
    <div class="con userCon">
		...
		<form action="editgroupC.html" method="post">
			<table class="HDZJ2016ht_TB1" style="width: 70%">
				<tr style="display: none">
					<td class="td1">id:</td>
					<td><input type="hidden" name="groupId"
						value="${groupInfo.groupId}" /></td>
				</tr>
				<tr>
					<td class="td1">用户组名称:</td>
					<td><input type="text" name="groupName"
						value="${groupInfo.groupName}" /></td>
				</tr>
				<tr>
					<td class="td1">用户组描述:</td>
					<td><input type="text" id="groupDesc" name="groupDesc"
						value="${groupInfo.groupDesc}"></td>
				</tr>
				<tr>
					<td class="td1">用户组类型:</td>
					<td><input type="text" id="groupType" name="groupType"
						value="${groupInfo.groupType}"></td>
				</tr>
			</table>
