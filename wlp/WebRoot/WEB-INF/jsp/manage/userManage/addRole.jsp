...
<body>
	...
	<div class="YJ2016_HTmain YJ2016_clearfix ">
		...
		<div class="con userCon">
			...
			<form action="${context}/manage/authority/addRoleC.html"
				method="post">
				<table class="HDZJ2016ht_TB1" style="width: 70%">
					<tr>
						<td class="td1" style="line-height: 38px;font-size: 15px;">角色名称:</td>
						<td><input  class="input1" type="text" name="roleName"/></td>
					</tr>
					<tr>
						<td class="td1" style="line-height: 38px;font-size: 15px;">角色描述:</td>
