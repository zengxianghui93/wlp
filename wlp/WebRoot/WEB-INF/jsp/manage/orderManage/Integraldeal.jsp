	...
	<div class="YJ2016_HTmain YJ2016_clearfix ">
		...
		<div class="con" align="center"  style="float: left;margin-left: 4%;margin-bottom: 4%">
			<div class="HTnd1" style="display: inline-block;" align="center" >
			  <form name="chongzhi" action="${context}/manage/Integral.html" method="post">
                ...
                <div class="HTnd_gdmod" align="center">
                    ...
                    <p><span style="width: 100px;margin-left:-40px" >原有积分：</span><input  type="text" name="yue" id="wf_searchStrategy" value="${account.integral}" style="width:60%;" readonly/></p>
                	<p><span style="width: 100px;margin-left:-40px" >增加积分：</span><input  type="text" name="jine" id="wf_searchStrategy" onfocus="txtonfocus(this)" onblur="txtonblur(this)" style="width:60%;" value='0'/></p>
                   <div align="center">
                    <span class="mod_btn1"> <a
							href="javascript:document:chongzhi.submit();" onclick=" return checkform()" class="creat">充值</a>
							<a href="${context}/manage/chongzhi.html">返回</a>
						</span>
						</div>
                </div>
