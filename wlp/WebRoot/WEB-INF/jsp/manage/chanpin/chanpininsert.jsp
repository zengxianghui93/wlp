	...
	<div class="YJ2016_HTmain YJ2016_clearfix ">
		...
		<div class="con" align="center" style="float: left; margin-left: 4%">
			<div class="HTnd1" style="display: inline-block;"
				...
				<span class="setTit">商品添加</span>
				<div class="HTnd_gdmod">
					<form name="form1"
						action="${context}/Chanpins/chanpininsert.html"
		...
		<div class="YJ2016_UserMain_form">
			<table class="form_tb1">
				...
				<tr>
					...
					<td width="200px" style="word-wrap:break-word;word-break:break-all;">
					    <c:forEach var="item" items="${etype}"  varStatus="st">
