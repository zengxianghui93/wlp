	...
	<div class="YJ2016_HTmain YJ2016_clearfix ">
		...
		<div class="con" align="center" style="left; margin-left: 4%">
			<div class="HTnd1" style="width:950px; display: inline-block;"
				...
				<span class="setTit">子商品添加</span>
				<div class="HTnd_gdmod">
					<form name="form1"
						action="${context}/Chanpins/zichanpininsert.html"
		...
		<div class="YJ2016_UserMain_form">
			<table class="form_tb1">
				<tr>
					...
					<td><input  type="text" name="wf_title"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="td1">价格：</td>
					<td><input type="text" name="wf_price" /></td>
				</tr>
				<tr>
					<td class="td1">折扣：</td>
					<td><select name="wf_afterDiscountPrice" style="padding: 0 10px; height: 30px;">
				...
				<tr>
					<td class="td1">页数：</td>
					<td><input type="text" name="wf_totalpage"/></td>
				</tr>
					<tr>
					<td class="td1">出版频率：</td>
					<td><input type="text" name="wf_pubFrequency"/></td>
				</tr>
					<tr>
					<td class="td1">出版年：</td>
					<td><input type="text" name="wf_year" /></td>
				</tr>
					<tr>
					<td class="td1">开本：</td>
					<td>
					...
					<td><input  type="radio" name="wf_continuousPub" checked="checked" value="1"/>是
					    <input  type="radio" name="wf_continuousPub" value="2"/>否
					</td>
				</tr>
				<tr>
					<td class="td1">是否有纸本：</td>
					<td><input  type="radio" name="wf_paper_no" checked="checked" value="1"/>是
					    <input  type="radio" name="wf_paper_no" value="0"/>否
					</td>
				</tr>
				<tr>
					<td class="td1">产品介绍：</td>
					<td><textarea name="wf_authorUnit" class="ckeditor textarea1"></textarea></td>
				</tr>
				<tr>
					<td class="td1">简介：</td>
				    <td><textarea name="wf_doccontent" class="ckeditor textarea1"></textarea>
						</td>
				</tr>
				<tr>
					<td class="td1">目录：</td>
					<td><textarea name="wf_by1" class="ckeditor textarea1" style="height:500px;"></textarea>
						</td>
				</tr>
				<tr>
